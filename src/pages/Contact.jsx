  ...
  return (
    <>
      ...
      <section className="flex justify-around items-center mb-8">
        {/* Map */}
        {/* <div className="mb-20 flex flex-col justify-center items-center w-auto mx-24">
          <h1 className="font-amatic text-8xl text-center mx-5">Visit Us</h1>
          <h3 className="font-amatic text-xl my-4 text-center italic">
            Our Location
          </h3>
