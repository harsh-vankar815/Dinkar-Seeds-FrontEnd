  ...
  return (
    <>
      <section className="flex justify-center items-center flex-col mb-11 ">
        {isMobile ? (
          <h1 className="font-amatic text-5xl text-center mt-16">Contact</h1>
        ) : (
          <h1 className="font-amatic text-8xl text-center mt-16">Contact</h1>
        )}
        <p className="font-amatic text-xl mt-4 text-center italic">
          Feel free to reach out us
        </p>
        {isMobile ? (
          <form onSubmit={handleSubmit} className="w-11/12 mt-8 space-y-6">
            <div className="grid">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  value={fullName}
                  className="text-xl p-3 my-4 border border-slate-300 rounded-lg "
                  type="text"
                  name="fullname"
                  id="fullname"
          ...
          <form onSubmit={handleSubmit} className="w-4/5 mt-8 space-y-6">
            <div className="grid grid-cols-2">
              <div className="flex flex-col">
                ...
                <input
                  onChange={(e) => setFullName(e.target.value)}
                  value={fullName}
                  className="text-xl p-3 m-4 border border-slate-300 rounded-lg "
                  type="text"
                  name="fullname"
                  id="fullname"
                  placeholder="Full Name"
      ...
      {isMobile ? (
        <section className="flex flex-col justify-around items-center mb-8">
          <div className="space-y-6 mb-10">
            <h2 className="text-3xl ml-3 font-bold text-gray-800 mb-8 font-poppins">
