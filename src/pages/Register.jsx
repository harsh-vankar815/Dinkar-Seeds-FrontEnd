...
const Register = ({ isMobile }) => {
  ...
  return (
    <div className="min-h-[95vh] flex justify-center items-center flex-col border ">
      <div className="logo">
        <GoSignIn size={70} />
      </div>
      ...
      {isMobile ? (
        <form className="space-y-4 w-[90vw]" action="" onSubmit={handleSubmit}>
          <div className="inputs flex flex-col space-y-2 mb-4">
              ...
              <input
                ...
                className="border hover:bg-gray-100 focus:bg-white focus:outline-green-700 placeholder:text-gray-400 h-10 p-4 rounded-lg border-slate-400"
              />
              ...
              <input
                ...
                className="border focus:bg-white focus:outline-green-700 hover:bg-gray-100 placeholder:text-gray-400 h-10 p-4 rounded-lg border-slate-400"
              />
            ...
            />
            <button
              className="h-0 w-0 relative left-[83vw] top-[-37px]"
            ...
            />
            <button
              className="relative w-0 left-[83vw] top-[-37px] h-0"
  ...
  c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"
            ...
            { isMobile ? <p className="text-md">Sign up with google</p>  : <p className="text-lg">Sign up with google</p>}
          </div>
        </form>
      ) : (
          ...
          <div className="inputs flex flex-col space-y-2 mb-4">
            <div className="">
              ...
              <input
                ...
                id="last"
                placeholder="Last name"
                className="border ml-1 focus:bg-white focus:outline-green-700 hover:bg-gray-100 placeholder:text-gray-400 h-10 p-4 rounded-lg border-slate-400"
              />
            </div>
            <label htmlFor="email"></label>
            <input
            ...
            />
            <button
              className="h-0 w-0 relative left-[430px] top-[-37px]"
              onClick={() => setShowPassword(!showPassword)}
            >
              {showPassword ? (
                <HiEyeOff className="h-5 w-5" />
            ...
            />
            <button
              className="relative w-0 left-[430px] top-[-37px] h-0"
              onClick={() => setShowPasswordCon(!showPasswordCon)}
            >
              {showPasswordCon ? (
                <HiEyeOff className="h-5 w-5" />
